...
function szem4_EPITO_motor(){try{
	...
	switch (EPIT_LEPES) {
		case 0: PMEP=szem4_EPITO_Wopen(); /*FaluID;lista;link_a_faluhoz*/
				...
				EPIT_REF.document.title = 'szem4/építő';
				break;

...
50%-kal nagyobb raktárkapacitás és kereskedőszám 9
50%-kal gyorsabb képzés a műhelyben 7
...
function keres(){
	...
	if (tav=="") {alert("A távolság egy pozitív valós szám lehet. Tizedesvessző elválasztására .-ot használj!");return;}
